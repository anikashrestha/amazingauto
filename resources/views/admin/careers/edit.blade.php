...
<div class="content-wrapper">
        ...
        <div class="panel-body">
            <form  action="{{ route('admin.careers.update',['id'=>$career->id])}}" method="POST" >
                {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('body')?'has-error':'' }}">
                                ...
                                <textarea style="height: 200px;" name="body1" id="body1" cols="5" rows="10" class="form-control">{{ $career->body1}}</textarea>
                        @if($errors->has('body1'))
                        ...
                        <div class="form-group {{ $errors->has('body')?'has-error':'' }}">
                                ...
                                <textarea style="height: 200px;" name="body2" id="body2" cols="5" rows="10" class="form-control">{{ $career->body2 }}</textarea>
                        @if($errors->has('body2'))
                        <span class="help-block">
                                {{ $errors->first('body2') }}
                        </span>
