...
<div class="content-wrapper">
    <div class="panel pandel-default">
        ...
        <form action="{{ route('admin.partnerproduct.storePartnerProduct')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}

                <div class="form-group">
                    <div class="{{ $errors->has('heading')?'has-error':'' }}">
                        <label for="title">Heading<label class="required-field-class">*</label></label>
                        <input type="text" name="heading" id="js-input-company-heading" placeholder="Heading" class="form-control">
                ...
                <div class="form-group">
                    <div class="{{ $errors->has('text')?'has-error':'' }}">
                        ...
                        <textarea name="text" id="js-input-text" class="form-control" placeholder="Text"></textarea>
