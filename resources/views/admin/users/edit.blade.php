...
<div class="content-wrapper">
      ...
      <div class="panel panel-default">
            <form action="{{ route('admin.users.updatestore',['id'=>$user->id]) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="panel-heading">
                   Edit User
                </div>
                        ...
                        <div class="form-group {{ $errors->has('role_id')?'has-error':'' }}">
                                ...
                                <select name="role_id" id="role_id"  class="form-control">
                                    ...
                                    @foreach($roles as $type)
                                            ...
                                            <option value="{{ $type->id }}" @if($type->id=== $user->roles()) selected='selected' @endif>{{ $type->name }}</option>
                                        @endforeach
                                    </select>
