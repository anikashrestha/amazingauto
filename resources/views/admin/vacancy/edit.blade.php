...
<div class="panel pandel-default">
    ...
    <div class="panel-body">
                <form autocomplete="off" action="{{ route('admin.vacancy.update',['id'=>$vacancy->id]) }}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('position')?'has-error':'' }}">
                            ...
                            <input type="text" class="form-control" name="position" id="position" value="{{ $vacancy->position}}">
                ...
                <div class="col-md-12" style="padding:0px;margin:auto;">
                        ...
                        <div class="form-group {{ $errors->has('no_of_opening')?'has-error':'' }}">
                                        ...
                                        <input type="number" class="form-control" name="no_of_opening" id="no_of_opening" value="{{ $vacancy->no_of_opening}}">
                        ...
                        <div class="form-group {{ $errors->has('education_level')?'has-error':'' }}">
                                ...
                                <input type="text" class="form-control" name="education_level" id="education_level" value="{{ $vacancy->education_level}}">
                ...
                <div class="row col-md-12" style="padding:0px; margin-left: 14px;">
                                ...
                                <textarea name="experience_required" id="experience_required" cols="5" rows="5" class="form-control">{{ $vacancy->experience_required}}</textarea>
                ...
                <div class="row col-md-12" style="padding:0px;margin-left:14px;">
                        <div class="form-group {{ $errors->has('job_specification')?'has-error':'' }}">
                                ...
                                <textarea name="job_specification" id="job_specification" cols="5" rows="5" class="form-control">{{ $vacancy->job_specification}}</textarea>
                ...
                <div class="row col-md-12" style="padding:0px;margin-left: 14px;">
                        <div class="form-group {{ $errors->has('job_description')?'has-error':'' }}">
                                        ...
                                        <textarea name="job_description" id="job_description" cols="5" rows="5" class="form-control">{{ $vacancy->job_description}}</textarea>
                ...
                <div class="form-group {{ $errors->has('deadline')?'has-error':'' }}">
                                ...
                                <input type="text" name="deadline" id="datepicker1" class="form-control" value="{{ $vacancy->deadline}}">
                ...
                <input type="checkbox" value="{{ $vacancy->status}}"  id="status" name="status" <?php echo ($vacancy->status==1 ? 'checked' : '')?>>
