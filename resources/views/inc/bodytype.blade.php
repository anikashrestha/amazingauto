...
<div class="container" >
			<section class="ftco-section ftco-category ftco-no-pt ">
				...
				<p id="brandmorescript" style="float:right; "> <a href = "brand" style="text-decoration:none;">View All Brand.. </a> </p>
			...
			<div class="container newrrivalbrand" >
				...
				<div id="myDIV22"> {{-- Company type section  --}}
					...
					@foreach($brands as $brand)
								<li >
										<a  href="cardetail" style="background-color:white">
											<img class="bgimage-manufactor ftco-animate ford" src="/storage/brands/{{$brand->brand_icon}}" alt="{{$brand->brand_icon}}"></img>
											<!-- <span class="spanarrival"></span> -->
